...
class Buying extends MY_Controller {
    ...
    public function __construct() {
        ...
        $data['sub_menu'] = array();
        $data['current_menu_text'] = 'Buying頁面管理';
    ...
    public function update() {
        $this->data['info'] = $this->buying_model->getDetail();
        $this->load->view('include/_header', $this->data);
        $this->load->view('buying_update', $this->data);
        $this->load->view('include/_footer', $this->data);
    }
    ...
    public function get() {
        ...
        switch($actionxm) {
            ...
            case 'getDetail':
                ...
                $result = $this->buying_model->getDetail();
                break;
        }
    ...
    public function post() {
        ...
        switch($actionxm) {
            ...
            case 'update':
                ...
                $result = $this->buying_model->update($nid, $params);
                break;
